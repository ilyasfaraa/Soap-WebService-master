 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://ws.abdtouirsi.com/", wsdlLocation = "http://localhost:8084/banque?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUEWS_QNAME = new QName("http://ws.abdtouirsi.com/", "BanqueWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8084/banque?wsdl");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://ws.abdtouirsi.com/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.abdtouirsi.com/", "BanqueServicePort"), BanqueService.class, features);
    }
