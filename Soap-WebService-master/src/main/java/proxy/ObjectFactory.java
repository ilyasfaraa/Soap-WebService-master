...
public class ObjectFactory {
    ...
    private static final QName _Compte_QNAME = new QName("http://ws.abdtouirsi.com/", "compte");
    private static final QName _Conversion_QNAME = new QName("http://ws.abdtouirsi.com/", "conversion");
    private static final QName _ConversionResponse_QNAME = new QName("http://ws.abdtouirsi.com/", "conversionResponse");
    private static final QName _GetCompte_QNAME = new QName("http://ws.abdtouirsi.com/", "getCompte");
    private static final QName _GetCompteResponse_QNAME = new QName("http://ws.abdtouirsi.com/", "getCompteResponse");
    private static final QName _ListComptes_QNAME = new QName("http://ws.abdtouirsi.com/", "listComptes");
    private static final QName _ListComptesResponse_QNAME = new QName("http://ws.abdtouirsi.com/", "listComptesResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://ws.abdtouirsi.com/", name = "compte")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.abdtouirsi.com/", name = "conversion")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.abdtouirsi.com/", name = "conversionResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.abdtouirsi.com/", name = "getCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.abdtouirsi.com/", name = "getCompteResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.abdtouirsi.com/", name = "listComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.abdtouirsi.com/", name = "listComptesResponse")
